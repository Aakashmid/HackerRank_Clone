...
export default function CertificationCard({ topicName }) {
  return (
    <>
      {topicName ? (
        <div className="md:w-[31%]  bg-bg3 p-7 md:p-6  w-full  rounded-xl h-40 flex flex-col justify-between ">
        ...
        (<div className="md:w-[31%]  bg-[#15172b5d] p-7 md:p-6  w-full  rounded-xl custom-shadow-darkb h-40 flex flex-col justify-between  ">
