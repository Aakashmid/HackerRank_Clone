...
export default function PageHeader({pageName,heading,bookmarkedChanllenges}) {
    return (<>
        <div className="pageHeader bg-bg3 p-4  lg:px-5 lg:py-6 w-full border-b md:border-none border-borderColor mt-0">
            <div className="xl:w-10/12 2xl:w-[70%]  mx-auto flex justify-between items-baseline">
                <div className="HeaderRight text-left">
                    ...
                    <h1 className="text-textPrimary font-semibold text-[1.5em]">{heading}</h1>
                </div>
